...
getEq<-function(a=1/14, b=.00068, m=40, n=45, g=.005, c=.28, r=1/(3*365), yonly=F)
{
...
getEq2<-function(a=1/14, b=.00068, m=40, n=45, g=.005, c=.28, r=1/(3*365), yonly=F)
{
  R0 <- (m*(a^2)*b*c*exp(-g*n)) / (r*g)
  S<-a/g
  Xeq<-(R0-1)/(R0+(c*S))
...
RMequil <- getEq3(a=1/14, b=.00068, m=40, n=45, g=.005, c=.28, r=1/(3*365))
