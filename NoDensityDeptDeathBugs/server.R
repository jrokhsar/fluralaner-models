...
#==========================================================================
#  Define inputs to create graphs of proportions bugs/dogs infected
#==========================================================================
server <- function(input, output) {
    ...
    output$distPlot1 <- renderPlot({
        ...
        #     -Removed density dependent death for bugs
        #     -Carrying capacity set to ratio of dogs to bugs
        #     -External bug population MM introduced
        #     -Commented out function to get equilibrium -return an error that says x and y must have same number of rows
        #=============================================
...
#            return(c(Xeq, Yeq))
#        }
#        RMequil <- getEq(a=a, b=b, m=m, n=n, g=g, c=c, r=r)
...
#        Yeq <- RMequil[2]
        ...
        ###### Plot the output
        matplot(times/365, RESULTS, type = "l", xlab = "Time", ylab = "Proportion (X,Y)", main = "Model w/o death dept density for bugs", lwd = 1, lty = 1, bty = "l", col = c("black","red"))
